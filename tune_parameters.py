...
def main():
    ...
    for instance in INSTANCES:
        ...
        step1_configs = [
            {"population_size": 30, "generations": 100, "mutation_type": "swap", "crossover_type": "OX"},
            {"population_size": 50, "generations": 100, "mutation_type": "swap", "crossover_type": "OX"},
            {"population_size": 100, "generations": 100, "mutation_type": "swap", "crossover_type": "OX"}
        ]
        step = 1
        best_config = None
        best_avg = float('inf')
